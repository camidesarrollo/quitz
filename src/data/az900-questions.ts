...
export const az900Questions: Question[] = [
  ...
  },
  {
    ...
    "options": [
      "Una máquina virtual y una zona de disponibilidad",
      "Dos máquinas virtuales y una zona de disponibilidad",
      "Una máquina virtual y dos zonas de disponibilidad",
      "Dos máquinas virtuales y dos zonas de disponibilidad"
    ],
  ...
  },
  {
    ...
    "options": [
      "Entidad del gobierno de los Estados Unidos",
  ...
  },
  {
    ...
    "options": [
      "Si tienen su infraestructura en una nube privada",
      "Si tienen su infraestructura en la nube pública",
      "Si tienen su infraestructura en una nube híbrida"
    ],
  ...
  },
  {
    ...
    "options": [
      "Necesitarían implementar una VPN",
      "Tendrían que pagar el costo de transferir el sitio web a Azure",
      "Tendrían que pagar los costos mensuales del alojamiento del sitio web",
      "Tendrían que pagar por el número de conexiones al sitio web"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Procesamiento por lotes de Azure",
  ...
  },
  {
    ...
    "options": [
      "Implementar en la misma región",
      "Implementar en el mismo grupo de recursos",
      "Implementar en la misma zona de disponibilidad",
      "Implementar en la misma escala"
    ],
  ...
  },
  {
    ...
    "options": [
      "Azure es una plataforma pública donde todos los recursos son accesibles al público",
      "Azure es una plataforma privada donde solo un grupo reducido puede acceder",
      "Azure es una plataforma compartida donde múltiples empresas usan una parte de los recursos",
      "Azure es una plataforma de comercio electrónico donde los usuarios compran y venden recursos"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "La nube pública es una solución de colaboración colectiva",
      "Todos los recursos de la nube pública son de libre acceso para cualquier persona",
      "La nube pública es una entidad compartida donde múltiples empresas usan parte de los recursos"
    ],
  ...
  },
  {
    ...
    "options": [
      "Instancias de VMs reservadas de Azure",
      "Azure DevTest Labs",
      "Conjuntos de escalado de VMs de Azure",
  ...
  },
  {
    ...
    "options": [
      ...
      "Se encuentra en todos los países donde Microsoft tiene oficina subsidiaria",
      "Se puede encontrar únicamente en países de Europa y América",
      "Contiene uno o más centros de datos conectados mediante una red de alta latencia"
    ],
  ...
  },
  {
    ...
    "options": [
      "Un fallo del servidor físico",
      "Un fallo en la región de Azure",
      "Un fallo de almacenamiento",
      "Un fallo en un centro de datos de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "Un grupo de seguridad de aplicaciones (ASG)",
      "10 puertas de enlace de red virtual",
      "10 circuitos de Azure ExpressRoute",
  ...
  },
  {
    ...
    "options": [
      "Un grupo de recursos para FinServer y otro para los demás servidores",
      "Una red virtual para FinServer y otra para los demás servidores",
      "Una VPN para FinServer y una puerta de enlace de red virtual para otro servidor",
      "Un grupo de recursos para todos los servidores y un bloqueo de recursos para FinServer"
    ],
  ...
  },
  {
    ...
    "options": [
      "Una base de datos Azure SQL",
      "Un disco de datos de máquina virtual",
      "Un servicio de archivos en una cuenta de almacenamiento",
      "Un servicio Blobs en una cuenta de almacenamiento"
    ],
  ...
  },
  {
    ...
    "options": [
      "Una aplicación web",
      "Una imagen de servidor en Azure Marketplace",
  ...
  },
  {
    ...
    "options": [
      ...
      "Un perfil de Azure Traffic Manager"
    ],
  ...
  },
  {
    ...
    "options": [
      "Plantillas de Azure Resource Manager",
      "Conjuntos de escalado de VMs",
      "El servicio Azure API Management",
      "Grupos de gestión"
    ],
    "correctAnswer": "Plantillas de Azure Resource Manager"
  },
  ...
  },
  {
    ...
    "options": [
      "No es necesario realizar ningún cambio",
      "El portal de socios de Microsoft Cloud",
      "Compliance Manager",
  ...
  },
  {
    ...
    "options": [
      "Crear una alerta de estado del servicio",
      "Actualizar tu plan de soporte",
      "Modificar una directiva de Azure",
  ...
  },
  {
    ...
    "options": [
      ...
      "Múltiples directorios de Microsoft Entra ID",
      "Varias regiones",
      "Múltiples grupos de recursos"
    ],
  ...
  },
  {
    ...
    "options": [
      "Solo Professional Direct",
      "Solo Professional Direct y Standard",
      "Solo Professional Direct, Standard y Developer",
      "Professional Direct, Standard, Developer y Basic"
    ],
  ...
  },
  {
    ...
    "options": [
      "Una suscripción para desarrolladores/pruebas",
      "Garantía de software",
      "Un Convenio Colectivo (CE)",
  ...
  },
  {
    ...
    "options": [
      "Microsoft ofrece soporte estándar por cinco años",
      "Microsoft requiere preaviso mínimo de 12 meses antes de finalizar el soporte para un servicio",
      "Una vez GA, Microsoft proporciona soporte por mínimo cuatro años",
      "Al retirarse un servicio, puede adquirir soporte extendido por hasta cinco años"
    ],
  ...
  },
  {
    ...
    "options": [
      "VMs: virtualización OS; Containers: portátil; App Service: apps web; Functions: sin servidor",
      "Functions: virtualización OS; VMs: portátil; Containers: apps web; App Service: sin servidor",
      "VMs: virtualización OS; Containers: portátil; App Service: apps web; Functions: sin servidor",
      "VMs: virtualización OS; Functions: portátil; App Service: apps web; Containers: sin servidor"
    ],
  ...
  },
  {
    ...
    "options": [
      "No es necesario realizar ningún cambio",
      "Dentro de una única región de Azure",
      "Dentro de varias regiones de Azure",
      "Dentro de un único centro de datos de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "No es necesario realizar ningún cambio",
      "Cuentas administrativas de Microsoft Entra ID",
  ...
  },
  {
    ...
    "options": [
      "Implementar MFA de Azure",
      "Sincronizar todas las cuentas de Active Directory con Microsoft Entra ID",
      "Indicar a todos los usuarios que cambien su contraseña",
      "Crear cuenta de usuario invitado en Microsoft Entra ID para cada usuario"
    ],
  ...
  },
  {
    ...
    "options": [
      "El sitio web del Centro de Conocimiento",
      "La sección Asesor del portal de Azure",
      "Compliance Manager desde el portal de confianza del servicio",
      "El panel del Centro de seguridad del portal de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "No es necesario realizar ningún cambio",
      "Términos y condiciones de los servicios en línea de Microsoft",
      "Acuerdo de nivel de servicio en línea de Microsoft",
      "Acuerdo de suscripción en línea para Microsoft Azure"
    ],
    "correctAnswer": "No es necesario realizar ningún cambio"
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "El portal de Azure",
      "El Centro del Conocimiento",
      "El centro de administración de Seguridad y Cumplimiento"
    ],
    "correctAnswer": "El portal de Azure"
  },
  {
  ...
  },
  {
    ...
    "options": [
      "No es necesario realizar ningún cambio",
      "Solo se puede configurar desde la CLI de Azure",
      "Excluidos de los Acuerdos de Nivel de Servicio",
      "Solo se puede configurar desde el portal de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Desarrollo",
      "Una suscripción a un Contrato Empresarial (EA)"
    ],
    "correctAnswer": "No es necesario realizar ningún cambio"
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "Configure una VPN de red virtual a red virtual",
  ...
  },
  {
    ...
    "options": [
      ...
      "Almacenamiento georredundante de solo lectura",
  ...
  },
  {
    ...
    "options": [
      "Azure Migrate: Evaluación de servidores",
      "Calculadora del coste total de propiedad (TCO) de Azure",
      "El asistente de migración de bases de datos",
      "La calculadora de precios en Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "Implementar VMs en dos o más zonas de disponibilidad",
      "Implementar VMs en dos o más grupos de recursos",
      "Implementar VMs en un conjunto de escalado",
      "Implementar VMs en dos o más regiones"
    ],
  ...
  },
  {
    ...
    "options": [
      "Bash en Azure Cloud Shell",
      "PowerShell en Azure Cloud Shell",
      "Portal de PowerApps",
      "Centro de administración de Seguridad y Cumplimiento",
      "Portal de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "CLI de Azure y portal de Azure",
      "Portal de Azure y Azure PowerShell",
      "CLI de Azure y Azure PowerShell",
      "CLI de Azure, portal de Azure y Azure PowerShell"
    ],
  ...
  },
  {
    ...
    "options": [
      "macOS con PowerShell Core 6.0",
      "Windows 10 con módulo Azure PowerShell",
      "Linux con módulo Azure PowerShell",
      "Linux con CLI de Azure instalada",
      "Chrome OS con Azure Cloud Shell"
    ],
  ...
  },
  {
    ...
    "options": [
      "Azure Monitor",
      "Microsoft Defender para la nube",
      "Protección de identidad de Microsoft Entra ID",
      "Microsoft Defender para la identidad"
    ],
  ...
  },
  {
    ...
    "options": [
      "Modificar un perfil de Azure Traffic Manager",
      "Modificar un NSG",
      "Modificar un plan de protección contra ataques DDoS",
      "Modificar un firewall de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "Control de acceso de Azure IAM",
      "Centros de eventos de Azure",
      "Registro de actividad de Azure",
      "Azure Service Health"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Se mueve automáticamente a otro grupo de recursos",
      "Continúa funcionando con normalidad",
      "Ahora es un objeto de solo lectura"
    ],
  ...
  },
  {
    ...
    "options": [
      "Declaración de privacidad de los servicios en línea de Microsoft",
      "Términos y condiciones de los servicios en línea de Microsoft",
      "Acuerdo de nivel de servicio en línea de Microsoft",
      "Acuerdo de suscripción en línea para Microsoft Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "Colección de definiciones de políticas",
      "Colección de asignaciones de definiciones de directivas de Azure",
      "Grupo de definiciones de Azure Blueprints",
      "Grupo de asignaciones de roles RBAC"
    ],
  ...
  },
  {
    ...
    "options": [
      "Una política de acceso condicional",
      "Azure Bastion",
      "Firewall de Azure",
      "Política de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "Grupos de seguridad de aplicaciones en Azure",
      "ID de Microsoft Entra",
      "Azure Key Vault",
      "Microsoft Defender para la nube"
    ],
  ...
  },
  {
    ...
    "options": [
      "Reembolso a tu cuenta bancaria",
      "Migrar el recurso a otra suscripción",
      "Abona el importe a tu cuenta de Azure",
      "Te envía un código de cupón de créditos de Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "Integrar Active Directory y Microsoft Entra ID",
      "Calcular los costos de una solución Azure",
      "Confirmar que la seguridad de la suscripción cumple las mejores prácticas",
      "Evaluar qué recursos locales se pueden migrar a Azure"
    ],
  ...
  },
  {
    ...
    "options": [
      "El producto de ambos SLAs, que equivale al 99,94%",
      "El SLA más bajo, del 99,95%",
      "El SLA más alto, del 99,99%",
      "La diferencia entre los dos SLAs, que es del 0,05%"
    ],
  ...
  },
  {
    ...
    "options": [
      "IoT Hub: bidireccional; IoT Central: SaaS IoT; Sphere: hardware+software seguridad",
      "Sphere: bidireccional; IoT Hub: SaaS IoT; IoT Central: hardware+software seguridad",
      "Sphere: bidireccional; IoT Central: SaaS IoT; IoT Hub: hardware+software seguridad",
      "IoT Hub: bidireccional; Sphere: SaaS IoT; IoT Central: hardware+software seguridad"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Los grupos de Entra ID",
      "Las cuentas de usuario de Entra ID"
    ],
  ...
  },
  {
    ...
    "options": [
      "Se puede acceder en cualquier momento mediante azcopy.exe",
      "Solo se puede leer mediante Azure Backup",
      "Deben restaurarse antes de poder acceder a los datos",
      "Deben rehidratarse antes de poder acceder a los datos"
    ],
  ...
  },
  {
    ...
    "options": [
      "Implementarse en una red virtual separada",
      "Ejecutar un sistema operativo diferente",
      "Implementarse en un grupo de recursos independiente",
  ...
  },
  {
    ...
    "options": [
      "Redes virtuales",
      "Balanceadores de carga",
      "Puertas de enlace de redes virtuales",
      "Zonas DNS",
      "Perfiles del gestor de tráfico",
  ...
  },
  {
    ...
    "options": [
      "Únicamente un miembro del grupo de administradores globales",
      "El bloqueo de eliminación debe eliminarse antes de que un administrador pueda hacerlo",
      "Una directiva de Azure debe modificarse antes de que un administrador pueda hacerlo",
      "Se debe agregar una etiqueta de Azure antes"
    ],
  ...
  },
  {
    ...
    "options": [
      "Security Center: logs; Lighthouse: puntuación; Key Vault: contraseñas",
      "Sentinel: logs; Lighthouse: puntuación; Key Vault: contraseñas",
      "Sentinel: logs; Security Center: puntuación; Key Vault: contraseñas",
      "Sentinel: logs; Security Center: puntuación; Entra ID: contraseñas"
    ],
  ...
  },
  {
    ...
    "options": [
      "Las directivas de Azure proporcionan",
      "Los grupos de recursos proporcionan",
      "Azure Resource Manager proporciona",
      "Los grupos de gestión proporcionan"
    ],
  ...
  },
  {
    ...
    "options": [
      "Para crear nuevas definiciones de políticas",
      "Para hacer cumplir los estándares de cumplimiento",
      "Para administrar grupos de recursos",
      "Para configurar la seguridad de la red",
      "Para automatizar la implementación de recursos"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Utilizar la ventaja híbrida de Azure",
      "Detener las VMs fuera del horario laboral",
      "Configurar los presupuestos de Azure Cost Management"
    ],
  ...
  },
  {
    ...
    "options": [
      "Implementar una VPN",
      "Pagar costos de uso mensuales",
      "Pagar para transferir todos los datos del sitio web a Azure",
  ...
  },
  {
    ...
    "options": [
      "Las políticas de Azure proporcionan",
      "Los grupos de recursos proporcionan",
      "Las plantillas de Azure Resource Manager proporcionan",
      "Los grupos de gestión proporcionan"
    ],
  ...
  },
  {
    ...
    "options": [
      "Implementar una VPN",
      "Pagar los costos de uso mensuales",
      "Pagar para transferir todos los datos del sitio web a Azure",
      "Reducir el número de conexiones al sitio web"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Definir reglas de escalabilidad",
      "Instalación de la solución SaaS",
      "Configurar la solución SaaS"
    ],
    "correctAnswer": "Configurar la solución SaaS"
  },
  ...
  },
  {
    ...
    "options": [
      "Sustitución de hardware de servidor averiado",
      "Realizar copias de seguridad de los datos de la aplicación",
      "Gestionar la seguridad de los servidores físicos",
      "Actualizar los sistemas operativos del servidor",
      "Gestionar los permisos de acceso a documentos compartidos"
    ],
